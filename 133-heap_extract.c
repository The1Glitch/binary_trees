...
/**
 * tree_height - Measure the heogt of a binary tree
 * @tree: Pointer to thre root node of the tree to measure the height
 *
 * Return: Heighr or 0 if tree is NULL
 */
 ...
 */
szie_t tree_size_h(const binary_tree_t *tree)
{
	size_t height_l = 0;
	size_t height_r = 0;
...
/**
 * heapify - heapfies max binary heap
...
/**
 * heap_extract - extracts the root node from a Max Bisnry Heap
